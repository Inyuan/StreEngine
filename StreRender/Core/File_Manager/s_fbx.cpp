 ...
 */
FbxString s_fbx::GetAttributeTypeName(FbxNodeAttribute::EType type) {
    switch (type) {
 ...
 * Print an attribute.
 */
void s_fbx::PrintAttribute(FbxNodeAttribute* pAttribute) {
 ...
 */
void s_fbx::PrintNode(FbxNode* pNode)
{
    PrintTabs();
 ...
 */
bool s_fbx::ReadFbx(const char* lFilename, bool IhasAnime)
{
...
void s_fbx::ProcessSkeletonHeirarchy(FbxNode* pNode)
{
...
void s_fbx::ProcessSkeletonHeirarchyre(FbxNode* pNode, int depth, int index, int parentindex)
{
...
void s_fbx::ProcessNode(FbxNode* pNode)
{
...
bool s_fbx::ProcessCamera()
{
    return true;
}
bool s_fbx::ProcessLight(FbxNode* pNode)
{
    return true;
}

bool s_fbx::ProcessMesh(FbxNode* pNode)
{
    pMesh = pNode->GetMesh();
    pMeshNode = pNode;
    if (pMesh == NULL)
...
void s_fbx::ReadVertex(int ctrlPointIndex, s_float3* pVertex)
{
...
void s_fbx::ReadColor(int ctrlPointIndex, int vertexCounter, s_float4* pColor)
{
...
bool s_fbx::ReadUV(int ctrlPointIndex, int textureUVIndex, int uvLayer, s_float2* pUV)
{
...
void s_fbx::ReadTangent(int ctrlPointIndex, int vertecCounter, s_float3* pTangent)
{
